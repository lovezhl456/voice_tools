...
| Python 默认 discovery | 503 项，467 通过、36 条件跳过；58.7 秒 |
...
- 本轮 QA 检索 15 项、gaps 检索 15 项、标注与 CSV 往返各 6 项、全程错误检查 1 项，共 43 项通过。
- 检查文件名片段、大小写、中文与多关键词、Windows 路径、目录交集、空白查询、无效录音选择清除、状态和证据组合、无匹配时的详情隐藏。
