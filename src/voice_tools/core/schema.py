...
def contract(parser, selected=None, native_parsers=None):
    ...
    return {"latency_contract": public_contract(), "schema_version": "1.0", "tool_version": __version__, "selected_tool": selected,
            ...
            "output": {"detect": "SQLite library; immutable definitions/batches, automatic tags and independent review revisions; report is a snapshot, review-import persists browser drafts; config-ui edits offline definitions; serve restores scoped workspaces and exposes local daily/trial runs, direct review persistence, explicit negative audits, frozen sample comparisons and daily rule selection", "gaps": "independent interval candidates, event exclusions and imported evidence; review-check validates separate human labels", "audio_qa": "one JSON object on stdout with ok, exit_code, status, summary, artifacts; errors have error.code/message",
            ...
            "exit_codes": {"0": "completed, not proof of audio quality", "1": "qa/gaps/detect/benchmark findings, nisqa insufficient evidence, or nisqa doctor not ready",
                           "2": "invalid arguments/input/runtime dependency", "3": "partial result or input errors; inspect artifacts"},
            "data_contracts": {"detection_definition": "1.0", "detection_review": "1.0", "detection_library": "1.0", "qa_assessment": "1.0", "recording_review": "1.0", "gaps_results": "1.0", "output_events": "1.0", "gap_evidence": "1.0", "gap_review": "1.0", "rtp_timeline": "1.0", "nisqa_provenance": "1.0", "task": "1.0", "voice_task": "1.0", "voice_result": "1.0", "task_run": "1.0", "results_jsonl": "1.0", "events": "1.0", "golden_read": ["1.0", "1.1"], "golden_write": "1.1",
