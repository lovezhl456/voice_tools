...
def contract(parser, selected=None, native_parsers=None):
    ...
    return {"schema_version": "1.0", "tool_version": __version__, "selected_tool": selected,
            ...
            "exit_codes": {"0": "completed, not proof of audio quality", "1": "qa/gaps findings, nisqa insufficient evidence, or nisqa doctor not ready",
                           "2": "invalid arguments/input/runtime dependency", "3": "partial result or input errors; inspect artifacts"},
            "data_contracts": {"gaps_results": "1.0", "output_events": "1.0", "gap_evidence": "1.0", "gap_review": "1.0", "rtp_timeline": "1.0", "nisqa_provenance": "1.0", "task": "1.0", "voice_task": "1.0", "voice_result": "1.0", "task_run": "1.0", "results_jsonl": "1.0", "events": "1.0", "golden_read": ["1.0", "1.1"], "golden_write": "1.1",
