...
- 状态：实现与本轮本地验收完成，[PR #32](https://github.com/lovezhl456/voice_tools/pull/32) 待审阅，尚未合并；独立分支 `feat/v0.16.1-autoqa`，基于主线 `a255ee5`。
- 范围：工程规则全量检查、固定版本本地 CPU 语音模型、整通三态判定、人工例外与抽检队列；保留原逐机会分析及人工黄金标签合同。
